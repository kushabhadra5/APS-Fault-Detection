...
class DataIngestion:
    ...
    def initiate_data_ingestion(self)->artifact_entity.DataIngestionArtifact:
        ...
        Step 4: Now from the created DataFrame train and test DataFrame is created using sklearn.model_selection.train_test_split function.
        Step 5: Then both train and test DataFrame are to be saved in the artifact/time_stapm/data_ingestion/dataset directory in csv format.
        Step 6: Preparing the artifact of data_ingestion component those are:
